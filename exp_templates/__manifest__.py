...
{
    'name': 'EXP Templates',
    'summary': 'This module redefines invoice and credit notes templates',
    'version': '1.0',
    'description': """
Invoices and credit notes templates are redefined in order to correspond to Expansion expectation.
        """,
